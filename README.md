...
> Frames75's comment: Extended tutorial from Auth0.com [Secure AWS API Gateway Endpoints Using Custom Authorizers](https://auth0.com/docs/integrations/aws-api-gateway-custom-authorizers#test-your-deployment)
